        ...
        <div class="container-xl">
            ...
            <div class="row g-3 mb-4 app-nav-tabs shadow-sm p-2 align-items-center justify-content-between">
                <div class="col-auto">
                    ...
                    <small>List of all orders available in the system.</small>
                    <?php } else {?>
                                ...
                                <table class="table app-table-hover mb-0 text-left">
                                    <thead>
                                        <tr>
                                            ...
                                            <?php if (isset($_SESSION['admin'])) :?>
                                            <th class="cell">Create Invoice</th>
                                            <?php endif;?>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td class="cell"><span
                                                    class="truncate"><?php echo ucwords($this->customer_name($order->customer_id)[0]->firstname.' '.$this->customer_name($order->customer_id)[0]->surname);?></span>
                                            </td>
                                            <td class="cell"><span
                                            ...
                                            <td class="cell"><a class="btn-sm app-btn-secondary"
                                                    href="<?php echo URL;?>createInvoice&id=<?php echo $order->customer_id;?>&orderId=<?php echo $order->id;?>">Invoice</a>
                                            </td>
                                            <?php } ?>
                                            <?php endif;?>
                                        </tr>
